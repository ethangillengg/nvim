...
local function lsp_keymaps(bufnr)
	...
	vim.api.nvim_buf_set_keymap(bufnr, "n", "gh", "<cmd>lua vim.diagnostic.open_float({scope='cursor'})<CR>", opts)
	...
	vim.api.nvim_buf_set_keymap(bufnr, "n", "J", '<cmd>lua vim.diagnostic.goto_next({ border = "rounded" })<CR>', opts)
	vim.api.nvim_buf_set_keymap(bufnr, "n", "<c-.>", "<cmd>lua vim.lsp.buf.code_action()<CR>", opts)
